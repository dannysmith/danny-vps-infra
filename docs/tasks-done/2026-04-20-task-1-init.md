...
> Copied over from /Users/danny/dev/loom-clone/docs/tasks-todo/task-2b-danny-vps-infra.md
...
- Create user `danny` with sudo + SSH keys copied from root (same pattern as mc-infra)
...
- Install user-level tools for danny: GitHub CLI, Bun, Claude Code
